...
**Статус:** ✅ DONE (архівовано без виконання)  
...
Архівовано **без виконання** на прохання користувача (2026-09-13). `.claude/settings.local.json` не змінювався: `defaultMode: "bypassPermissions"` і `skipDangerousModePermissionPrompt: true` лишаються.
Кроки плану вище залишаються актуальними. Якщо проєкт піде в production або спільний доступ, відновити задачу з архіву.
